<template>
  <div>
    <el-row :gutter="20">
      <el-col :span="8">
        <div class="card kjfs">
          ...
          <ul>
            <li><router-link to="/system/user" class="kjfs kjfs-bluee"><span><i class="fa fa-user-o"></i></span><span>用户管理</span></router-link></li>
      ...
      <el-col :span="8">
        <div class="card bbxx">
          ...
          <div class="table">
            ...
            <p><span class="tit">主要功能</span>图标 / 穿梭框 / 表格 / 上传</p>
          </div>
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
<!--        <line-echarts id="lineEcharts" height="400px" ref="echarts"></line-echarts>-->
        <div class="card bbxx">
          <UserChar ref="echarts"/>
        </div>
      </el-col>
    </el-row>
  </div>
...
import UserChar from '../system/user/UserChar'
export default {
  name: 'mainIndex',
  components: {UserChar},
